...
function page() {
  ...
  return (
    <div className='text-mediumBlack p-4 max-w-full mt-0'>
        <h2 className='hidden'>Draft Order</h2>
        <div className='w-full py-2 px-0 flex flex-wrap flex-row gap-4 items-start'>

        <div className='w-full max-w-[500px] grid grid-cols-1 gap-4'>
